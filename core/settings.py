...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'mirmaruf07.pythonanywhere.com']
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Dravon Server API',
    'DESCRIPTION': 'API documentation for Dravon Server',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@dravon.com')